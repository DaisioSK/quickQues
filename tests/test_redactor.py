...
from jcontract.impls.dict_regex_redactor import DictRegexRedactor, JsonlMappingStore
...
def _make_redactor(
    ...
    return DictRegexRedactor(dictionary_path=dict_path, store_path=tmp_path / store_name)
